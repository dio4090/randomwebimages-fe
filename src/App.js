                ...
                <div className="card shadow-sm">
                  <div className="bd-example">  
                    ...
                    <div className="center">
                      {/* <img id="img_home2" src="assets/dist/img/Reload-1s-200px.gif" className="card-img-top" alt="Loading..."> */}
                      <img id="img_home2" src={loadImage} className="card-img-top" alt="Loading..."/>
                    </div>
                  ...
                  <div className="card-body">
                    <div className="d-flex justify-content-between align-items-center">
                      <div className="btn-center">
                        ...
                        {/* <button type="button" className="btn btn-outline-success" onClick="downloadImage2()">Go to Image</button> */}
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="col">
                <div className="card shadow-sm">
                  <div className="bd-example">
                    ...
                    <div className="center">
                      {/* <img id="img_home3" src="assets/dist/img/Reload-1s-200px.gif" className="card-img-top" alt="Loading..."> */}
                      <img id="img_home3" src={loadImage} className="card-img-top" alt="Loading..."/>
                    </div>
                  ...
                  <div className="card-body">
                    <div className="d-flex justify-content-between align-items-center">
                      <div className="btn-center">
                        <Button variant="outline-success">Go to Image</Button>
                        {/* <button type="button" className="btn btn-outline-success" onClick="downloadImage3()">Go to Image</button> */}
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="col">
                <div className="card shadow-sm">
                  <div className="bd-example">
                    ...
                    <div className="center">
                      {/* <img id="img_home1" src="assets/dist/img/Reload-1s-200px.gif" className="card-img-top" alt="Loading..."> */}
                      <img id="img_home1" src={loadImage} className="card-img-top" alt="Loading..."/>
                    </div>
                  ...
                  <div className="card-body">
                    <div className="d-flex justify-content-between align-items-center">
                      <div className="btn-center">
                        <Button variant="outline-success">Go to Image</Button>
                        {/* <button type="button" className="btn btn-outline-success" onClick="downloadImage1()">Go to Image</button> */}
                      </div>
                    </div>
                  </div>
                </div>
